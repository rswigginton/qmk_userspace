...
//Custom
// Note: Vial provides get_quick_tap_term through QMK settings
// To disable quick tap for specific keys like LT(1,KC_SPACE),
// consider using HOLD_ON_OTHER_KEY_PRESS or configuring through Vial GUI
